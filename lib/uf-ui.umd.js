...
//
//
var types = ['primary', 'default', 'normal', 'combox', 'comboxlink', 'more', 'radio', 'link', 'iconlink'];
/* harmony default export */ var UfButtonvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    panelItemH: function panelItemH() {
      var h = 30;
  ...
  mounted: function mounted() {
    ...
    setTimeout(function () {
      _this.panelWidth = _this.$(_this.$refs.btn).outerWidth();

      if (_this.type === 'combox') {
        _this.panelTop = _this.$(_this.$refs.btn).outerHeight() + 1;
      }

      if (_this.type === 'comboxlink') {
        _this.panelTop = _this.$(_this.$refs.btn).outerHeight() + 5;
      }
    }, 20);
  },
  watch: {
  ...
  methods: {
    ...
    getTypeStr: function getTypeStr(type) {
      var classStr = 'btn-normal';

      if (types.some(function (i) {
        return i === type;
      })) {
        classStr = 'btn-' + type;
      }
    ...
    onBtnItemClick: function onBtnItemClick(item, e) {
      if (!this.disabled) {
        this.open = !this.open;
...
// CONCATENATED MODULE: ./packages/button/src/UfButton.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_UfButtonvue_type_script_lang_js_ = (UfButtonvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./packages/button/src/UfButton.vue?vue&type=style&index=0&lang=css&
var UfButtonvue_type_style_index_0_lang_css_ = __webpack_require__("18af");
...
// CONCATENATED MODULE: ./packages/button/src/UfButton.vue
...
var component = normalizeComponent(
  src_UfButtonvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=uf-ui.umd.js.map