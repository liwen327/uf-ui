 ...
 * @LastEditTime: 2020-11-11 11:27:12
...
export default {
  ...
  created() {
    ...
    if (selEnviornmentVar) {
      agencyCode = selEnviornmentVar.selAgecncyCode ? selEnviornmentVar.selAgecncyCode : agencyCode
      agencyName = selEnviornmentVar.selAgecncyName ? selEnviornmentVar.selAgecncyName : agencyName
      acctCode = selEnviornmentVar.selAcctCode ? selEnviornmentVar.selAcctCode : acctCode
      acctName = selEnviornmentVar.selAcctName ? selEnviornmentVar.selAcctName : acctName
    }
    // console.log(agencyCode, agencyName, acctCode, acctName)
    // this.searchText =
    //   agencyCode +
    //   " " +
    //   agencyName +
